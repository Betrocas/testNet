...
function consultar() {
    fetch("https://localhost:7097/Category/Consultar")
        .then((resp) => resp.json())
        .then(data => {
            clienteLista = data;
            console.log(data);
...
function renderList(list) {
    ...
    list.forEach(e => {
        ...
        card.innerHTML = renderObj(e.id, e.nombre, e.descripcion);
...
function addAddCard() {
    ...
    fc.innerHTML = `<div class="card-body">
                ...
                <div>
                    ...
                    <input type="text" class="form-control border-0" placeholder="descripcionPrueba" id="addDescripcion">
                </div>
                <div class="row mt-2">
                    <div class="col-12">
...
function renderObj(id, nombre, descripcion) {
    let obj = `
                <div class="card-body">
                    ...
                    <div>
                        <label class="form-label">Descripcion</label>
                        <textarea type="text" class="form-control border-0" id="descripcion_${id}">${descripcion}</textarea>
                    </div>
                    <div class="row mt-2">
                        <div class="col-6">
...
function btnEditar(id) {
    ...
    console.log(temp);
    fetch("https://localhost:7097/Category/Editar", {
        method: "POST",
        headers: {
...
function btnAgregar() {
    ...
    console.log(obj);
    fetch("https://localhost:7097/Category/Agregar", {
        method: "POST",
        headers: {
            'Content-Type': 'application/json'
        },
